<template>
    <div class="all-div">
        ...
        <div class="intro-div">
            ...
            <br />
            <span style="text-align: center;">客服热线/虚假信息举报：400-620-6688邮箱：service@58ganji.comCopyright © 2007-2017 www.anjuke.com All Rights Reserved ICP号：沪 B2-20090008</span>
        </div>
    </div>
</template>

<script>
import cmpHouseDetailDiv from '@/components/cmp-hosedetail-div'
import cmpRightadDiv from '@/components/cmp-rightad-div'
import cmpGuessdetailDiv from '@/components/cmp-guesslist-div'
import cpmInfoItem from '@/components/cmp-info-item'

export default {
  name: 'index',
  components: { cmpHouseDetailDiv, cmpRightadDiv, cmpGuessdetailDiv, cpmInfoItem },
  data(){
      let dataBus = {}
      this.$a.get('http://localhost:8081').then(res=>{
          alert('数据成功')
      },err=>{
          alert('失败了!')
      })

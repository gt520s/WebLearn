    ...
    <div class="all2-div">
        ...
        <div class="contain-div">
            ...
            <div class="basicdetail-div">
                <div class="basicprice-div">参考价格  住宅<span style="font-size: 30px;font-size: 30px;vertical-align: -2px;color: #f60;margin: 0 5px;">38994</span> 元/㎡  </div>
                <div class="basicprice-div">楼盘户型  三室(1)，四室(1) </div>
                <div class="basicprice-div">楼盘地址  [ 房山 - 良乡 ] 良乡镇</div>
        ...
        <div class="guwen-div">
            ...
            <div class="guwen-content">
                <ul>
                    <li><img src="/static/img/teacher1.jpg" alt="老师" /><div class="teachername-div">
                        <div class="teachernameleft-div">靳艳艳 <a href="#" class="yuyue-div">预约</a></div>	</div>
                    </li>
                    <li><img src="/static/img/teacher1.jpg" alt="老师" /><div class="teachername-div">
                        <div class="teachernameleft-div">靳艳艳 <a href="#" class="yuyue-div">预约</a></div>	</div>
                    </li>

...
<!---->
<div class="index-3E3kS_0" style="display: none;">
  <div style="position: sticky; top: 0px; z-index: 1000;">
    <div class="index-1oqna_0" style="top: 0px; z-index: 1000;">
      <svg class="index-ay9_n_0">
        <use xlink:href="#arrow-left"></use>
      </svg>
      <div class="index-1figq_0">
        选择收货地址
      </div>
      <!---->
    </div>
  </div>
  <div class="index-3TpFe_0">
    <!---->
    <form class="index-2pbY-_0">
      <svg class="index-1KxBl_0">
        <use xlink:href="#search"></use>
      </svg>
      <input type="search" placeholder="请输入地址" autofocus="autofocus" class="index-1XPPS_0" />
    </form>
  </div>
  <section style="display: none;"></section>
  <section class="index-2jRO2_0">
    <h4>当前地址</h4>
    <div class="index-1H9W0_0">
      <span>北京市朝阳区</span>
      <span class="index-3cUrU_0">
       <svg class="">
        <use xlink:href="#locate"></use>
       </svg><span>重新定位</span></span>
    </div>
  </section>
  <section class="index-2jRO2_0" style="display: none;">
    <h4>收货地址</h4>
  </section>
  <!---->
  <div class="spinner" style="display: none;"></div>

        ...
        <ul infinite-scroll-distance="20">
          ...
          <li class="index-RD5RX">
            <div class="comment-block-Mh_9k">
              ...
              <div class="comment-block-3ul4F">
                <div class="comment-block-hOaYf">
                  <h3 class="comment-block-2u8__">匿名用户</h3>
                  <small class="comment-block-2lqfX">2018-02-04</small>
                </div>
                <div>
                  <div class="Rating-wrapper_TYbDrku_0">
                    <div class="Rating-gray_1kpffd5_0">
                  ...
                  <span class="comment-block-rYfog">60分钟送达</span>
                </div>
                <!---->
                <!---->
                <!---->
            ...
            <div class="comment-block-Mh_9k">
              ...
              <div class="comment-block-3ul4F">
                ...
                <div>
                  ...
                  <span class="comment-block-rYfog">50分钟送达</span>
                </div>
                <!---->
                <!---->
                <!---->
          ...
          <li class="index-RD5RX">
            <div class="comment-block-Mh_9k">
              ...
              <div class="comment-block-3ul4F">
                <div class="comment-block-hOaYf">
                  <h3 class="comment-block-2u8__">匿名用户</h3>
                  <small class="comment-block-2lqfX">2018-02-02</small>
                </div>
                <div>
                  <div class="Rating-wrapper_TYbDrku_0">
                    <div class="Rating-gray_1kpffd5_0">
          ...
          <li class="index-RD5RX">
            <div class="comment-block-Mh_9k">
              ...
              <div class="comment-block-3ul4F">
                <div class="comment-block-hOaYf">
                  <h3 class="comment-block-2u8__">匿名用户</h3>
                  <small class="comment-block-2lqfX">2018-01-30</small>
                </div>
                <div>
                  <div class="Rating-wrapper_TYbDrku_0">
                    <div class="Rating-gray_1kpffd5_0">
                  ...
                  <span class="comment-block-rYfog">按时送达</span>
                </div>
                <!---->
                <!---->
                <!---->
          ...
          <li class="index-RD5RX">
            <div class="comment-block-Mh_9k">
              ...
              <div class="comment-block-3ul4F">
                <div class="comment-block-hOaYf">
                  <h3 class="comment-block-2u8__">匿名用户</h3>
                  <small class="comment-block-2lqfX">2018-01-16</small>
                </div>
                <div>
                  <div class="Rating-wrapper_TYbDrku_0">
                    <div class="Rating-gray_1kpffd5_0">
                  ...
                  <span class="comment-block-rYfog">40分钟送达</span>
                </div>
                <!---->
                <!---->
                <!---->
...
<script>
  import Data_detail from '@/assets/data_detail.json'
  export default {
  data () {
    return {
      data_detail : []

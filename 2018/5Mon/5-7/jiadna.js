...
fetch('http://jandan.net/ooxx').then(res=>{
    let {buffer,headers} = res;
   // fs.writeFile('fff.html',buffer.toString())
...
var aa = function(m, r, d) {
    ...
    if (e == "DECODE") {
        m = m.substr(q);
        //k = base64_decode(m)
        k = new Buffer(m, 'base64').toString()
    }
    var h = new Array(256);
...
let dd = aa('1433iOcJsvZAbRK4vw90dEewX+OqkRq8rgwObVbLJ7iRtzJnVW3PkON5pjWpviwFkKi25Hzp/fIwZF9euGpYaXgAeeJ0zcwe3yUiQi8Bm1zgr6dnRqwbcw','zE4N6eHuAQP8vkQPb0wcuEcWnLzHYVhy');
console.log(dd)
